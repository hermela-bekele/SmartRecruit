...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: "/add-hr",
      roles: ["SUPER_ADMIN"], // Only SUPER_ADMIN can access this
    },
    {
      name: "Settings",
  ...
  console.log('Authorized nav items:', authorizedNavItems);
          ...
          <div className="absolute left-full top-0 ml-4 w-48 pointer-events-none">
            {authorizedNavItems.map((item) => (
              <motion.div
                ...
                style={{ top: `${authorizedNavItems.indexOf(item) * 56 + 160}px` }}
              >
                {item.name}
              </motion.div>
            ))}
